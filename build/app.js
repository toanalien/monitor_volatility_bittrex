...
(function(){
  var async, lodash, request, express, ms, app, server_port, time_cache, limitOrderBook, CACHE, WALL_DATA, LIST_PAIR, objToString, textError, raschet, raschetChange, percentageBetweenNumbers, orderBook, orderBookPair, currencyPairList, loadDataPair, reg, htmlData, loading, main, request_n;
  async = require('async');
    ...
    return reg("getmarketsummaries", function(err, body){
      ...
      Object.keys(obj.result).forEach(function(key){
        pair_max_pr[obj.result[key].MarketName] = {
          ...
          change: raschetChange(obj.result[key].PrevDay, obj.result[key].Last).toFixed(2)
        };
      });
      return cbk(null, {
