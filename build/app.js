...
(function(){
  var async, lodash, request, express, ms, app, server_port, time_cache, limitOrderBook, CACHE, WALL_DATA, LIST_PAIR, objToString, textError, differenceBetweenNumbers, percentageBetweenNumbers, orderBook, orderBookPair, currencyPairList, loadDataPair, reg, htmlData, loading, main, request_n;
  async = require('async');
